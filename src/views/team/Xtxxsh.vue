  ...
  <div>
    <el-main>
      ...
      <div class="box0">
        ...
        <div style="margin-right: 10%">
          <span style="font-size: 13px; margin-right: 10px;">队长学校</span>
          <el-input placeholder="请输入内容"
      ...
      <div>
        <el-button type="primary"
                   ...
                   @click="handleBatchReviewPass"><i class="el-icon-circle-plus-outline"
             style="margin-right:5px"></i>批量审核通过</el-button>
        <el-button type="danger"
                   style="margin-bottom:5px"
                   @click="handleBatchReviewFail"><i class="el-icon-remove-outline"
             style="margin-right:5px"></i>批量审核不通过</el-button>
      </div>
