    ...
    <el-main>
      <div class="box">
        <div>
          ...
          <el-input placeholder="请输入内容"
                    v-model="rev_info.batch_name"
                    style="width: 250px;"></el-input>
        </div>
        <div>
          <span style="font-size: 13px; margin-right: 10px;">团队名称</span>
          <el-input placeholder="请输入内容"
                    v-model="rev_info.team_name"
                    style="width: 250px;"></el-input>
        </div>
        <div>
          <span style="font-size: 13px; margin-right: 10px;">作品名称</span>
          <el-input placeholder="请输入内容"
                    v-model="rev_info.work_name"
                    style="width: 250px;"></el-input>
        </div>
      </div>
      <div class="box">
        <div>
          ...
          <el-input placeholder="请输入内容"
                    v-model="rev_info.ques_name"
                    style="width: 250px; margin-top: 5px;"></el-input>
        </div>
        <div>
          <span style="font-size: 13px; margin-right: 10px;">专家名称</span>
          <el-input placeholder="请输入内容"
                    v-model="rev_info.expert_name"
                    style="width: 250px; margin-top: 5px;"></el-input>
        </div>
        <div>
          <span style="font-size: 13px; margin-right: 10px;">专家单位</span>
          <el-input placeholder="请输入内容"
                    v-model="rev_info.expert_organization_name"
                    style="width: 250px; margin-top: 5px;"></el-input>
        </div>
      </div>
      <div>
      ...
      <div style="padding: 30px 0;">
        <div style="float: right; margin-top: 10px; margin-bottom: 10px">
          ...
          <el-button @click="exp"><i class="el-icon-download"
               style="margin-right:5px"></i>导出评阅信息</el-button>
        </div>
      </div>
      <el-table :data="tableData"
        ...
        <el-table-column label="操作"
          ...
          <template slot-scope="scope">
            <el-button type="text"
                       @click="checkRevInfo(scope.row)">查看评阅结果</el-button> / <el-popconfirm confirm-button-text='确定'
              ...
              <el-button type="text"
                         style="margin-left: 0"
                         slot="reference">退回</el-button>
            </el-popconfirm>
          </template>
        </el-table-column>
        <el-table-column prop="batch.name"
                         label="批次名称"
                         width="180">
        </el-table-column>
        ...
        <el-table-column prop="work.name"
                         label="作品名称"
                         width="180">
        </el-table-column>
        ...
        <el-table-column prop="expert.name"
                         label="专家名称"
                         width="160">
        </el-table-column>
        <el-table-column prop="expert.organization_name"
                         label="专家所在单位"
                         width="180">
        </el-table-column>
        ...
        <el-table-column prop="rev_show"
                         label="评阅状态"
                         width="160">
        </el-table-column>
        <el-table-column prop="finish_date"
                         label="评阅时间"
                         width="160">
        </el-table-column>
      </el-table>
      ...
      <el-dialog title="查看评阅结果"
                 :visible.sync="dialogFormVisible"
                 width="50%">
        <div>
          <el-table :data="tablePreData"
                    border
                    strips
                    :header-cell-class-name="headerBg">
            <el-table-column type="index"
            ...
            <el-table-column prop="scorePoint"
                             label="评分项"
                             width="240">
            </el-table-column>
