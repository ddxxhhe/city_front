<template>
  <div>
      ...
      <div style="margin-bottom: 15px">
        <span style="font-size: 13px; margin-right: 10px;">批次名称</span><el-input placeholder="请输入内容" v-model="batch_name" style="width: 250px; margin-top: 10px;"></el-input>
        <span style="font-size: 13px; margin-left: 10px;">评审指标</span><el-input placeholder="请输入内容" v-model="rule_name" style="width: 250px; margin-left: 10px;"></el-input>
        <span style="font-size: 13px; margin-left: 15px;">赛事名称</span><el-input placeholder="请输入内容" v-model="contest_name" style="width: 250px; margin-top: 5px; margin-left: 10px;"></el-input>
      ...
      <div style="float: left; margin-bottom: 10px">
        <el-button type="primary" style="margin-bottom:5px" @click="handleAdd"><i class="el-icon-circle-plus-outline" style="margin-right:5px"></i>新增批次</el-button>
      </div>
      <div style="float: right; margin-bottom: 10px">
        <el-button style="margin-bottom:5px" @click="exp"><i class="el-icon-download" style="margin-left:5px"></i>导出评审批次信息</el-button>
      </div>
      <el-table :data="tableData" border strips :header-cell-class-name="headerBg">
        ...
        <el-table-column label="操作" width="120">
          ...
          <template slot-scope="scope">
            <el-button type="text" @click="checkInfo(scope.row)">查看批次信息</el-button>
          </template>
        </el-table-column>
        <el-table-column prop="name" label="批次名称" width="140">
        </el-table-column>
        <el-table-column prop="rule.name" label="评审指标" width="140">
        </el-table-column>
        <el-table-column prop="contest.name" label="赛事名称" width="140">
        </el-table-column>
        <el-table-column prop="work_expert" label="作品评审专家数量" width="120">
        </el-table-column>
        <el-table-column prop="expert_work" label="专家评审作品数量" width="120">
        </el-table-column>
        <el-table-column prop="start_date" label="评审开始时间" width="210">
        </el-table-column>
        <el-table-column prop="end_date" label="评审截止时间" width="210">
        </el-table-column>
        <el-table-column prop="is_aveg" label="是否去除最大最小成绩" width="160">
        </el-table-column>
        <el-table-column prop="is_max" label="是否只取最大成绩" width="140">
        </el-table-column>
      </el-table>
      ...
      <el-dialog title="批次信息" :visible.sync="dialogFormVisible" width="30%">
        <el-form :model="form" label-width="160px" ref="form">
          <el-form-item v-if="!!this.batchForm.name" label="批次名称">
            ：{{this.batchForm.name}}
          </el-form-item>
          <el-form-item v-if="!!(this.batchForm.rule).name" label="评审指标">
  ...
  <div style="margin-top: 20px" v-if="active === 0">
      <el-form :label-position="labelPosition" label-width="140px" :model="batchCache" ref="batchCache">
            <el-row>
                <el-col :span="8">
                ...
                <el-col :span="8">
                    <el-form-item label="作品评审专家数量" :required="true">
            ...
            <el-row>
                <el-col :span="8">
                    <el-form-item label="专家评审作品上限" :required="true">
                        <el-input v-model="batchCache.expert_work"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="评审开始日期" :required="true">
                      <el-date-picker
      v-model="batchCache.start_date"
      type="date"
      placeholder="选择开始日期">
    </el-date-picker>
                    </el-form-item>
                ...
                <el-col :span="8">
                    <el-form-item label="评审截至日期" :required="true">
                            <el-date-picker
      v-model="batchCache.end_date"
      type="date"
      placeholder="选择截至日期">
    </el-date-picker>
                    </el-form-item>
            ...
            <el-row>
                <el-col :span="8">
                    <el-form-item label="去除最大最小成绩">
                          <el-radio v-model="is_aveg" label="是">是</el-radio>
                          <el-radio v-model="is_aveg" label="否">否</el-radio>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="只取最大成绩">
                          <el-radio v-model="is_max" label="是">是</el-radio>
  <el-radio v-model="is_max" label="否">否</el-radio>
                    </el-form-item>
                </el-col>
            </el-row>
</el-form>
  ...
  <div style="margin-top: 20px" v-if="active === 1">
          <el-table :data="tableTeamData" border strips :header-cell-class-name="headerBg"
      @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="question.name" label="赛题" width="180">
        </el-table-column>
        <el-table-column prop="team_leader" label="队长姓名" width="180">
        </el-table-column>
        <el-table-column prop="leader_school" label="队长所在学校" width="180">
        </el-table-column>
        <el-table-column prop="leader_phone" label="队长手机号" width="180">
        </el-table-column>
        <el-table-column prop="advisor" label="指导教师" width="160">
        </el-table-column>
        <el-table-column prop="submit_date" label="提交作品时间" width="220">
        </el-table-column>
      </el-table>
  </div>
  <div style="margin-top: 20px" v-if="active === 2">
        <el-table :data="tableExpertData" border strips :header-cell-class-name="headerBg"
      @selection-change="handleSelectionChange">
        <el-table-column
          type="selection"
          width="55">
