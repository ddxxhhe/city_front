  ...
  <div>
    <el-main>
      <div style="margin-bottom: 15px">
        ...
        <span style="font-size: 13px; margin-left: 10px;">参赛状态</span>
        <el-input placeholder="请输入内容"
                  v-model="ques_state"
      ...
      <div style="float: left; margin-bottom: 10px">
        <el-button type="primary"
             ...
             style="margin-right:5px"></i>加入团队</el-button>
      </div>
      <el-table :data="tableData"
        ...
        <el-table-column label="操作"
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text"
                       style="margin-left: 0"
                       slot="reference">查看参赛作品</el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="user_state"
                         label="成员状态"
                         width="300">
        </el-table-column>
        <el-table-column prop="work_state"
                         label="作品状态">
        </el-table-column>
      </el-table>
