<template>
  <div>
      ...
      <div class="box">
        <div>
            <span style="font-size: 13px; margin-right: 10px;">队长姓名</span><el-input placeholder="请输入内容" v-model="team_leader" style="width: 250px; margin-top: 5px;"></el-input>
        </div>
        <div>
            <span style="font-size: 13px; margin-right: 10px;">队长所属学校</span><el-input placeholder="请输入内容" v-model="leader_school" style="width: 250px; margin-top: 5px"></el-input>
        </div>
        <div>
            <span style="font-size: 13px; margin-right: 10px;">队长手机号</span><el-input placeholder="请输入内容" v-model="leader_phone" style="width: 250px; margin-top: 5px"></el-input>
        </div>
      </div>
      ...
      <div style="padding: 30px 0;">
        ...
        <div style="float: right; margin-top: 10px; margin-bottom: 10px">
            ...
            <el-button @click="exp"><i class="el-icon-download" style="margin-right:5px"></i>导出参赛队伍获奖情况</el-button>
        </div>
      </div>
      ...
      @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="140">
          ...
          <template slot-scope="scope">
            <el-button type="text" @click="handleEditAward(scope.row)">设置奖项</el-button> / <el-button type="text" @click="handleCheckInfo(scope.row)" style="margin-left: 0" slot="reference">查看信息</el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="team_leader" label="队长姓名" width="200">
        </el-table-column>
        <el-table-column prop="leader_school" label="队长所在学校" width="200">
        </el-table-column>
        <el-table-column prop="leader_phone" label="队长手机号" width="200">
        </el-table-column>
        <el-table-column prop="advisor" label="指导教师" width="200">
        </el-table-column>
      </el-table>
      ...
      <el-dialog title="设置团队奖项" :visible.sync="dialogFormVisible" width="30%">
      ...
      <el-dialog title="查看队伍信息" :visible.sync="InfoVisible" width="30%">
        <span>这是一段信息</span>
